...
<div class="site-section bg-light">
    <div class="container">
        ...
        <div class="bg-white py-4 mb-4">
            <div class="row mx-4 my-4 product-item-2 align-items-start">
                ...
                <div class="col-md-5 ml-auto product-title-wrap">
                    ...
                    <p><span data-height="17">DSS s</span><span data-height="17">ervice </span><span data-height="17">это:</span></p>
                    ...
                    <a href="/ordersto/58" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block">Заказать</a>
                    <p></p>
                </div>
            </div>
        </div>
        <div class="text-center">
            ...
            Если список рекомендуемых меньше нуля то показать товары из этой же категории рандомно три штуки
            А в админке чтобы можно было указать список рекомендуемых
        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-5 forproduct-item" style="display: block;">
                <div class="product-item">
                    ...
                    <div class="px-4">
                        ...
                        <div>
                            <a href="https://kommesk-home.kz/" class="btn btn-black mr-1 rounded-0 readmore readmoresm" style="white-space: pre-line;" target="_blank">ПЕРЕЙТИ НА САЙТ</a>
                            <a href="/show/55" class="btn btn-black btn-outline-black ml-1 rounded-0 readmore readmoresm">Подробнее</a>
                        </div>
                    </div>
                </div>
            </div>		  <div class="col-lg-4 col-md-6 mb-5 forproduct-item" style="display: block;">
                <div class="product-item">
