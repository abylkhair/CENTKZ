...
$(function(){
	...
	$('.imageBlock0').live('dblclick', function(){
		...
		if(e.attr('type') == 'files')
		{
			...
			text += '</a> ' + ' ('+filesize+') ';
		//	$("#name").val(text)
	//	window.parent.document.getElementById('name').value=text;
...
//return;
		...
		{
		//	if (e.attr('path')=='/edu/sitepics/prews'){
//window.parent.document.getElementById('preview1').innerHTML="<img src='"+e.attr('linkto')+"'>";}
