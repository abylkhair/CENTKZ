    ...
    function d(b) {
        ...
        i = v.getNode(), j = w.getParent(i, "a[href]"), m = h(), u.text = k = j ? j.innerText || j.textContent : v.getContent({
            ...
            onSubmit: function(b) {
                ...
                var e;
                return u = tinymce.extend(u, b.data), (e = u.href) ? e.indexOf("@") > 0 && -1 == e.indexOf("//") && -1 == e.indexOf("mailto:") ? void c("The URL you entered seems to be an email address. Do you want to add the required mailto: prefixxxx?", function(a) {
                    a && (e = "mailto:" + e), d()
                    ...
                    a && (e = "http://" + e), d()
                }) :  e.indexOf("pdf")>0  ? void c("The URL you entered seems to be an pdf link. Do you want to add the required http:// prefix?", function(a) {
                    a && (e = "pdf://" + e), d()
